...
\textcolor{blue}{The} Bloc would be granted authority to negotiate all health care products and services, even those that are reasonably and comparatively priced, such as generic drugs. Universal scope does not mean universal action. Where competition produces low prices on its own, the Bloc need not negotiate. But every exemption written into the statute invites manufacturers to reformulate into the exempt category, and every exempted therapeutic class becomes the next target of pricing abuse (see \href{https://rabbanimaysam.github.io/health-reform-proposal/faq.html}{FAQ \faqComprehensiveScope}).
